...
class ProductControllerTest {
    ...
    @DisplayName("신규 상품을 등록할 때에 상품 타입은 필수입니다")
    @Test
    void createProductTypeException() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
            .sellingStatus(SELLING)
            .name("아메리카노")
    ...
    @DisplayName("신규 상품을 등록할 때에 상품 판매상태는 필수입니다")
    @Test
    void createProductSellingStatusException() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
            .type(HANDMADE)
            .name("아메리카노")
    ...
    @DisplayName("신규 상품을 등록할 때에 상품 이름은 필수입니다")
    @Test
    void createProductNameException() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
            .type(HANDMADE)
            .sellingStatus(SELLING)
    ...
    @DisplayName("신규 상품을 등록할 때에 상품 가격은 양수입니다")
    @Test
    void createProductPriceException() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
            .type(HANDMADE)
            .sellingStatus(SELLING)
